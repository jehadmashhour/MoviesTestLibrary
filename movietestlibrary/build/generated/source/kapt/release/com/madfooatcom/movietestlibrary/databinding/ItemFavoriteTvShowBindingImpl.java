...
public class ItemFavoriteTvShowBindingImpl extends ItemFavoriteTvShowBinding implements com.madfooatcom.movietestlibrary.generated.callback.OnClickListener.Listener {
    ...
    public ItemFavoriteTvShowBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 8, sIncludes, sViewsWithIds));
    }
    private ItemFavoriteTvShowBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        this.tvItemDetailsTvFavorite.setTag(null);
        this.tvOverview.setTag(null);
        this.tvRating.setTag(null);
        setRootTag(root);
        // listeners
        mCallback4 = new com.madfooatcom.movietestlibrary.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.image == variableId) {
            ...
            setTvShows((com.madfooatcom.movietestlibrary.data.local.entity.TvShowDetailEntity) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setTvShows(@Nullable com.madfooatcom.movietestlibrary.data.local.entity.TvShowDetailEntity TvShows) {
    ...
    protected void executeBindings() {
        ...
        com.madfooatcom.movietestlibrary.data.local.entity.TvShowDetailEntity tvShows = mTvShows;
        ...
        if ((dirtyFlags & 0x10L) != 0) {
            ...
            this.tvItemDetailsTvFavorite.setOnClickListener(mCallback4);
        }
    }
    ...
    public final void _internalCallbackOnClick(int sourceId , android.view.View callbackArg_0) {
        ...
        // tvShows.id
        java.lang.Integer tvShowsId = null;
        // handler
        com.madfooatcom.movietestlibrary.ui.handler.EventHandler handler = mHandler;
        // tvShows != null
