...
public class ItemMoviesBindingImpl extends ItemMoviesBinding implements com.madfooatcom.movietestlibrary.generated.callback.OnClickListener.Listener {
    ...
    public ItemMoviesBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 8, sIncludes, sViewsWithIds));
    }
    private ItemMoviesBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback6 = new com.madfooatcom.movietestlibrary.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.image == variableId) {
            ...
            setMovie((com.madfooatcom.movietestlibrary.data.local.entity.MovieEntity) variable);
        }
    ...
    public void setMovie(@Nullable com.madfooatcom.movietestlibrary.data.local.entity.MovieEntity Movie) {
        this.mMovie = Movie;
        synchronized(this) {
            mDirtyFlags |= 0x4L;
        }
    ...
    protected void executeBindings() {
        ...
        com.madfooatcom.movietestlibrary.data.local.entity.MovieEntity movie = mMovie;
        ...
        if ((dirtyFlags & 0x10L) != 0) {
            ...
            this.tvItemDetails.setOnClickListener(mCallback6);
        }
        if ((dirtyFlags & 0x14L) != 0) {
            // api target 1
