...
public class FragmentMovieBindingImpl extends FragmentMovieBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.shimmerMovie, 3);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.adapter == variableId) {
            setAdapter((com.madfooatcom.movietestlibrary.ui.adapter.MovieAdapter) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setAdapter(@Nullable com.madfooatcom.movietestlibrary.ui.adapter.MovieAdapter Adapter) {
    ...
    protected void executeBindings() {
        ...
        com.madfooatcom.movietestlibrary.ui.adapter.MovieAdapter adapter = mAdapter;
